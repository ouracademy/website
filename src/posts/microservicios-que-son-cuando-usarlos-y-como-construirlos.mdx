...
author: arthur
tags: [microservicios]
description: Una guia o serie de recursos para aprender de microservicios (microservices), traducido de Martin Fowler
---
...
- [Prerequisitos de microservicios](/posts/prerrequisitos-de-microservicios.mdx): Lo que debes saber antes de aplicar microservicios de lo contrario tendrás serias dificultades
