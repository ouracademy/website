...
Stanford CoreNLP integra muchas herramientas de Procesamiento de lenguaje natural, entre nos sera de utilidad: Named Entity Recognizer (NER) y Relation Extractor Annotator.

Para usar estas herramientas desplegaremos el CoreNLP Server, esto requiere que descarguemos: [corenlp.zip](https://nlp.stanford.edu/software/stanford-corenlp-full-2018-10-05.zip) y [modelo en español](https://nlp.stanford.edu/software/stanford-spanish-corenlp-2018-10-05-models.jar);
luego se descomprime el corenlp.zip y se coloca en una carpeta ambos archivos, digamos la carpeta **corenlp**.
