...
Más importante que usar un vocabulario reestringido, un Repository bien definido debería exponer conceptos del Modelo de Dominio como parte de su [interfaz pública](http://martinfowler.com/ieeeSoftware/published.pdf).
